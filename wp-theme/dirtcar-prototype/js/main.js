...
// Countdown timer
// WP theme version: race date comes from the #countdown element's
// data-race-date attribute, set server-side in template-parts/rail.php
// from dirtcar_get_data(). Falls back to the prototype's placeholder date
// if the attribute is somehow missing.

const countdownEl = document.getElementById('countdown');
const RACE_DATE = new Date(countdownEl?.dataset.raceDate || '2026-08-13T19:00:00-05:00');
